...
if __name__ == '__main__':
    appTuple = ('3028524014','660eb5d3feacc40d3bba28e0b9dcc50b','https://api.weibo.com/oauth2/default.html',\
                'wghxa@sohu.com','920115') #note:you can applicate some test accounts
    ...
    userID = '2654042367'#AppClient.getCurrentUid()
